...
STAR_CHANNEL_RED = 189  # Red color channel value star.
STAR_CHANNEL_GREEN = 40  # Green color channel value star.
STAR_CHANNEL_BLUE = 28  # Blue color channel value star.

PLANET_SIZE = 100  # Size of planet diameter in pixels.
PLANET_INIT = 250  # Start height of planet in pixels from the bottom.
PLANET_ANGLE = 0  # Relative speed of planet orbit in y direction. Positive is up, negative is down.
